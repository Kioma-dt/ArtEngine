...
QT_MOC_LITERAL(8, 79, 8) // "SlotExit"
    ...
    "FindWindow\0SignalFind\0\0targetValue\0"
...
void FindWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FindWindow::*)(int , uintptr_t , uintptr_t );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FindWindow::SignalFind)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FindWindow::SignalFind(int _t1, uintptr_t _t2, uintptr_t _t3)
{
